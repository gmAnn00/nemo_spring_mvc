...
<html lang="ko">
    <head>
        ...
        <script src="${contextPath}/resources/js/replyForm.js"></script>
    </head>
                ...
                <div class="boardWrite sc2_subsection">
                    ...
                    <div class="boardWriteArea">
                        <form action="${contextPath}/qna/addqna" method="post" name="qnaArticleForm" id="qnaArticleForm">
                            <input type="hidden" name="parent_no" value="${param.parent_no}" />

                            <!-- 제목 영역 -->
                            <div class="articleWritingTitle">
                                <!-- 제목 -->
                                <div class="titleArea">
                                    <input type="text" name="title" id="writeTitle" class="writeTitle" placeholder="제목을 입력해주세요" />
                                </div>
                            </div>
                            <!-- 글쓰는 영역 -->
                            ...
                            <div class="btnRegister">
                                ...
                                <a href="#" role="button" class="buttonCancle" onclick="fn_cancel(${param.parent_no})">취소</a>
                            </div>
                        </form>
                    </div>
                </div>
