...
public class GroupVO {
	...
	public String getGroup_img() {
		try {
			...
			System.out.println("getGroup_img error");
		}
		return group_img;
	}
	...
	public void setGroup_img(String group_img) {
		try {
			...
			System.out.println("setGroup_img error");
			e.printStackTrace();
		}
	}
	...
	public String toString() {
		return "GroupVO [group_id=" + group_id + ", group_name=" + group_name + ", group_leader=" + group_leader
